...
(function($, window) {
  ...
  ZammadChat = (function(superClass) {
    ...
    ZammadChat.prototype.enterOfflineMode = function() {
      ...
      this.el.find('.zammad-chat-welcome-subtext').replaceWith($('<span>').addClass('zammad-chat-welcome-offline-status').append($('<span>').addClass('zammad-chat-welcome-offline-dot')).append(document.createTextNode(this.T("We're offline right now"))));
      ...
      startAction.find('.js-home-start-label').text(this.T('Leave us a message'));
    ...
    ZammadChat.prototype.submitOfflineMessage = function(event) {
      ...
      if (!content) {
        this.el.find('.js-offline-compose-error').text(this.T('Please write a message.')).removeClass('zammad-chat-is-hidden');
        return;
      }
    ...
    ZammadChat.prototype.submitFeedback = function(event) {
      ...
      if (!this.feedbackScore) {
        this.el.find('.js-feedback-error').text(this.T('Please select a rating.')).removeClass('zammad-chat-is-hidden');
        return;
      }
    ...
    ZammadChat.prototype.onFeedbackSubmitResult = function(data) {
      ...
      if (data.state !== 'ok') {
        this.el.find('.js-feedback-error').text(data.message || this.T('Could not save your feedback. Please try again.')).removeClass('zammad-chat-is-hidden');
        return;
      }
